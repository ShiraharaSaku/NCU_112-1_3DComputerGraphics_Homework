public class Renderer{
    ...
    public Renderer(){
      box = new Box(renderer_size.x,renderer_size.y,renderer_size.z - renderer_size.x,renderer_size.w - renderer_size.y);
      box.setBoxColor(250);
    ...
    public void run(){      
      ...
      image(renderBuffer, renderer_size.x, renderer_size.y, renderer_size.z - renderer_size.x, renderer_size.w - renderer_size.y);
      if(debug)gameObject.forEach(GameObject::debugDraw);
...
public class Inspector{
    ...
    public void setGameObject(GameObject go){
        ...
        for(int i=0;i<position_slider.length;i++){
            position_slider[i] = new Slider(box.pos.add(new Vector3(40,30 + i * 20,0)),new Vector3(box.pos.x + 40,box.pos.x + 150,0),new Vector3(-1,1,0),true);            
        }
        ...
        for(int i=0;i<rotation_slider.length;i++){
            rotation_slider[i] = new Slider(box.pos.add(new Vector3(40,30 + i * 20 + 100,0)),new Vector3(box.pos.x + 40,box.pos.x + 150,0),new Vector3(0,6.28,0),true);            
        }
        ...
        for(int i=0;i<scale_slider.length;i++){
            scale_slider[i] = new Slider(box.pos.add(new Vector3(40,30 + i * 20 + 200,0)),new Vector3(box.pos.x + 40,box.pos.x + 150,0),new Vector3(0.1,3,0),true);            
        }
    ...
    public void run(){   
        ...
        if(gameObject!=null){
            ...
            gameObject.transform.position = new Vector3(position_slider[0].value(),position_slider[1].value(),position_slider[2].value());
            ...
            gameObject.transform.rotation = new Vector3(rotation_slider[0].value(),rotation_slider[1].value(),rotation_slider[2].value());
            ...
            gameObject.transform.scale = new Vector3(scale_slider[0].value(),scale_slider[1].value(),scale_slider[2].value());
